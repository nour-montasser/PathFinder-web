...
final class Version20250328034332 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE application_job CHANGE job_offer_id job_offer_id BIGINT DEFAULT NULL, CHANGE id_user id_user BIGINT DEFAULT NULL, CHANGE cv_id cv_id BIGINT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE job_offer CHANGE id_user id_user BIGINT DEFAULT NULL, CHANGE description description TEXT NOT NULL');
        ...
        $this->addSql('ALTER TABLE skilltest CHANGE id_job_offer id_job_offer BIGINT DEFAULT NULL');
        ...
        $this->addSql('CREATE INDEX IDX_6647AA18A8BF8669 ON skilltest (id_job_offer)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_75E7356C3481D195 ON application_job');
        $this->addSql('DROP INDEX IDX_75E7356C6B3CA4B ON application_job');
        $this->addSql('DROP INDEX IDX_75E7356CCFE419E2 ON application_job');
        $this->addSql('ALTER TABLE application_job CHANGE job_offer_id job_offer_id BIGINT NOT NULL, CHANGE id_user id_user BIGINT NOT NULL, CHANGE cv_id cv_id BIGINT NOT NULL');
        ...
        $this->addSql('ALTER TABLE job_offer CHANGE id_user id_user BIGINT NOT NULL, CHANGE description description VARCHAR(1000) NOT NULL');
        ...
        $this->addSql('ALTER TABLE skilltest CHANGE id_job_offer id_job_offer BIGINT NOT NULL');
