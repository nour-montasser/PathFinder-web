...
final class Version20250328034332 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE ApplicationJob ADD CONSTRAINT FK_75E7356C6B3CA4B FOREIGN KEY (id_user) REFERENCES App_user (id_user)');
        ...
        $this->addSql('ALTER TABLE JobOffer ADD CONSTRAINT FK_288A3A4E6B3CA4B FOREIGN KEY (id_user) REFERENCES App_user (id_user) ON DELETE CASCADE');
