 ...
 */
final class Version20250326015643 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
      ...
      /*  $this->addSql('ALTER TABLE applicationservice ADD CONSTRAINT FK_A89D71943F0033A2 FOREIGN KEY (id_service) REFERENCES serviceoffre (id_service) ON DELETE CASCADE');
        ...
        $this->addSql('DROP INDEX id_user ON job_offer');
        $this->addSql('ALTER TABLE job_offer ADD date_posted DATETIME NOT NULL, DROP datePosted, CHANGE id_offer id_offer BIGINT NOT NULL, CHANGE description description VARCHAR(1000) NOT NULL, CHANGE type type VARCHAR(255) NOT NULL, CHANGE number_of_spots number_of_spots INT NOT NULL, CHANGE required_education required_education VARCHAR(255) NOT NULL, CHANGE required_experience required_experience VARCHAR(255) NOT NULL, CHANGE skills skills VARCHAR(255) NOT NULL, CHANGE field field VARCHAR(255) NOT NULL, CHANGE address address VARCHAR(255) NOT NULL');
        ...
        $this->addSql('DROP INDEX id_job_offer ON skilltest');
    ...
    public function down(Schema $schema): void
    {
      ...
      /*  $this->addSql('ALTER TABLE applicationservice DROP FOREIGN KEY FK_A89D71943F0033A2');
        ...
        $this->addSql('CREATE INDEX id_job_offer ON skilltest (id_job_offer)');
