 ...
 */
final class Version20250329025919 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE application_job CHANGE idUser id_user BIGINT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE application_job CHANGE id_user idUser BIGINT DEFAULT NULL');
    }
}
